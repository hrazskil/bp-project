<<<<<<< HEAD
function [points, weigths, order] = getLebedevSphere(degreeInput)
...
%% check input
availableDegree = [6, 14, 26, 38, 50, 74, 86, 110, 146, 170, 194, 230, 266, ...
   302, 350, 434, 590, 770, 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, ...
   3470, 3890, 4334, 4802, 5294, 5810];

% find closest value
tempDiff = abs(availableDegree - degreeInput);
[~, ind] = min(tempDiff);
degree = availableDegree(ind);

%% inform about degree change
if degreeInput ~= degree
   fprintf('Value %1$d is not allowed, it was changet to value %2$d. \n', degreeInput, degree);
end
...
switch (degree)
   ...
   case 6
      ...
      [leb_tmp, ~] = getLebedevReccurencePoints(1,start,a,b,v,leb_tmp);
   ...
   case 14
      ...
      [leb_tmp, ~] = getLebedevReccurencePoints(3,start,a,b,v,leb_tmp);
   ...
   case 38
      ...
      [leb_tmp, ~] = getLebedevReccurencePoints(5,start,a,b,v,leb_tmp);
   ...
   case 50
      ...
      [leb_tmp, ~] = getLebedevReccurencePoints(4,start,a,b,v,leb_tmp);
   ...
   case 146
      ...
      [leb_tmp, ~] = getLebedevReccurencePoints(6,start,a,b,v,leb_tmp);
...
% prepare output
points = [leb_tmp.x leb_tmp.y leb_tmp.z];
weigths = leb_tmp.w;
order = leb_tmp.n;
end
...
>>>>>>> ef89ca621a3ab18de5c464e84bf285ac1b6ea6e8
