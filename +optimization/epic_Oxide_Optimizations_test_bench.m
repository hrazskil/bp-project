...
fF_ref = fieldEvaluation.farField(rObserved, dipoleRef, frequency);
...
fF_pso = fieldEvaluation.farField(rObserved, dipolePso, frequency);
...
fF_Fmincon = fieldEvaluation.farField(rObserved, dipoleFmincon, frequency);
...
fF_ga = fieldEvaluation.farField(rObserved, dipoleGa, frequency);
